...
export default function ResistorAnimation(props) {
    useEffect(() => {
        ...
        const terminals = new THREE.Line(
        ...
        directionalLight.lookAt(-5, 1, 40);
        directionalLight.position.set(-5, 1, 40);
    ...
    return (
        ...
        >
            <div className="carousel-inner col-md-12">
                <canvas
                    id="resistorDesign"
                    className="d-block w-75 mx-auto border-bottom border-primary"
                />
            </div>
        </div>
    );
